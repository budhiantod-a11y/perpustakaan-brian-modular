...
// ─── Breakdown per kategori (untuk collapsible card di Cashflow tab) ──────────

function calcBreakdown(ledger, type) {
  const byCat = {};
  for (const e of ledger) {
...
export function calcIncomeBreakdown(ledger)  { return calcBreakdown(ledger, 'income');  }
export function calcExpenseBreakdown(ledger) { return calcBreakdown(ledger, 'expense'); }
